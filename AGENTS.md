...
- **Always read `docs/prd.md`, `docs/architecture.md`, and `docs/dev-tools.md`** at the start of a new conversation to understand the project's architecture, goals, style, and constraints.
...
- **Internal tools naming**: Prefix with `dev-tools-` followed by a hyphenated noun/phrase (e.g. `dev-tools-categorisation-debugger`).
